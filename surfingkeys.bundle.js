...
#sk_status, #sk_find {
  ...
  function openFuzzyFinder() {
    ...
    container.className = "fixed top-[20%] left-1/2 -translate-x-1/2 bg-gray-800 text-white rounded-xl shadow-2xl z-[9999] w-[500px] max-h-[60vh] p-4 overflow-hidden";
    container.id = "fzf-finder";
    const input = document.createElement("input");
    input.className = "w-full px-3 py-2 mb-2 rounded bg-gray-900 text-white outline-none border border-gray-600";
    ...
    const renderResults = (query) => {
      ...
      results.forEach((r, idx) => {
        ...
        div.className = "px-3 py-2 bg-gray-700 hover:bg-gray-600 cursor-pointer rounded text-sm";
  ...
  // surfingkeys.js
  function injectTailwind(callback) {
